...
# def plotter(model, dataset, ground_truth, anomaly_score, labels, savepath,
#             results=None, ae_recon=None, diff_sample=None, preds=None, 
#             dim=0, plot_test=True, epoch=0, set='test'):
...
#     #plots/plots3
#     if dataset:
#         folder = os.path.join(savepath, f'/{model}_{dataset}')
#     else:
#         folder = os.path.join(savepath, f'/{model}')
#     os.makedirs(folder, exist_ok=True)
#     plt.savefig(os.path.join(folder,f'dim_{dim}_epoch_{epoch}.jpg'))
#     plt.close()
#     return fig
